...
export const getImageUrl = path => {
    return `https://raw.githubusercontent.com/matttttt/counter-strike-image-tracker/main/static/panorama/images/${path}_png.png`;
};

export const getImageUrlSvg = path => {
    return `https://raw.githubusercontent.com/matttttt/counter-strike-image-tracker/main/static/panorama/images/${path}.svg`;
};
...
export const IMAGES_INVENTORY_URL =
    "https://raw.githubusercontent.com/matttttt/counter-strike-image-tracker/main/static/images.json";
